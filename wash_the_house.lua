--[[
    JUNEJO ULTRA SCRIPT HUB - WASH THE HOUSE
...
for _, name in ipairs({"JunejoKeySystemUI_WashTheHouse", "JunejoHubUI_WashTheHouse", "JunejoWashHouseUI"}) do
                ...
                if hrp then
                    for _, obj in ipairs(Workspace:GetDescendants()) do
                        ...
                        if obj:IsA("BasePart") then
                            local n = obj.Name:lower()
                            if n:find("cash") or n:find("coin") or n:find("money") or n:find("dollar") or n:find("currency") or n:find("drop") then
...
ScreenGui.Name = "JunejoWashHouseUI"
...
AddToggleRow("Auto Clean House", "AutoClean")
AddToggleRow("Auto Collect Cash", "AutoCash")
