--[[
    ...
    Target Game: Capybaras VS Plants (Roblox)
...
for _, name in ipairs({"JunejoKeySystemUI_Capybaras", "JunejoHubUI_Capybaras", "JunejoCapybarasUI"}) do
    ...
    while true do
        ...
        if Toggles.AutoFarm then
            pcall(function()
                ...
                -- Remote scanner for attack/farm
                for _, remote in ipairs(ReplicatedStorage:GetDescendants()) do
                    if not Toggles.AutoFarm then break end
                    if remote:IsA("RemoteEvent") then
                        local n = remote.Name:lower()
                        if n:find("attack") or n:find("farm") or n:find("hit") or n:find("damage") or n:find("harvest") then
                            remote:FireServer()
            ...
            pcall(function()
                for _, remote in ipairs(ReplicatedStorage:GetDescendants()) do
                    ...
                    if remote:IsA("RemoteEvent") or remote:IsA("RemoteFunction") then
                        local n = remote.Name:lower()
                        if n:find("buy") or n:find("purchase") or n:find("unlock") or n:find("spawn") or n:find("capybara") then
                            if remote:IsA("RemoteEvent") then
        ...
        if Toggles.AutoMoney then
            pcall(function()
                ...
                if hrp then
                    for _, obj in ipairs(Workspace:GetDescendants()) do
                        ...
                        if obj:IsA("BasePart") then
                            ...
                            if n:find("coin") or n:find("cash") or n:find("money") or n:find("drop") or n:find("reward") then
                ...
                for _, remote in ipairs(ReplicatedStorage:GetDescendants()) do
                    ...
                    if remote:IsA("RemoteEvent") then
                        local n = remote.Name:lower()
                        if n:find("collect") or n:find("claim") or n:find("income") or n:find("money") or n:find("cash") then
                            remote:FireServer()
                            remote:FireServer(1)
                        end
                    end
...
ScreenGui.Name = "JunejoCapybarasUI"
...
AddToggleRow("Auto Farm Plants", "AutoFarm")
AddToggleRow("Auto Buy Best Capybara", "AutoBuy")
AddToggleRow("Auto Collect Money", "AutoMoney")
