--[[
    Junejo Ultra Script Hub - Wash the House (Monetized Edition with Key System)
...
local GAME_KEY_PREFIX = "WTH_"
local VALID_KEYS = {
    ["WTH_K9F2N8X4P7Q1M5W3Z6B8R0L2T4J9"] = true
}

local ONLINE_KEY_RAW_URL = "https://raw.githubusercontent.com/junejo18146/ultrascripthub/main/key_wash_the_house.txt"
local LOOTLABS_GET_KEY_LINK = "https://lootlabs.com" -- Will be updated when Junejo provides the LootLabs link!

-- Cleanup previous GUI instances
for _, name in ipairs({"JunejoKeySystemUI_WashTheHouse", "JunejoHubUI_WashTheHouse"}) do
...
----------------------------------------------------
-- JUNEJO KEY SYSTEM UI (BEFORE MAIN HUB LOADS)
----------------------------------------------------
local KeyGui = Instance.new("ScreenGui")
KeyGui.Name = "JunejoKeySystemUI_WashTheHouse"
...
local KeyHeaderTitle = Instance.new("TextLabel")
KeyHeaderTitle.Size = UDim2.new(1, -40, 1, 0)
KeyHeaderTitle.Position = UDim2.new(0, 14, 0, 0)
KeyHeaderTitle.BackgroundTransparency = 1
KeyHeaderTitle.Text = "WASH THE HOUSE KEY SYSTEM"
KeyHeaderTitle.TextColor3 = Color3.fromRGB(255, 255, 255)
KeyHeaderTitle.TextSize = 13
KeyHeaderTitle.Font = Enum.Font.GothamBold
KeyHeaderTitle.TextXAlignment = Enum.TextXAlignment.Left
KeyHeaderTitle.Parent = KeyHeader

local KeyClose = Instance.new("TextButton")
KeyClose.Size = UDim2.new(0, 40, 0, 40)
KeyClose.Position = UDim2.new(1, -40, 0, 0)
KeyClose.BackgroundTransparency = 1
KeyClose.Text = "X"
KeyClose.TextColor3 = Color3.fromRGB(160, 160, 170)
KeyClose.TextSize = 15
...
KeyContent.Size = UDim2.new(1, -28, 1, -80)
KeyContent.Position = UDim2.new(0, 14, 0, 40)
...
-- Key Input Field Box (#1B1B20, border #2D2D37)
local KeyTextBox = Instance.new("TextBox")
KeyTextBox.Name = "KeyTextBox"
KeyTextBox.Size = UDim2.new(1, 0, 0, 36)
KeyTextBox.BackgroundColor3 = Color3.fromRGB(27, 27, 32)
...
KeyFooter.Size = UDim2.new(1, 0, 0, 36)
KeyFooter.Position = UDim2.new(0, 0, 1, -36)
KeyFooter.BackgroundTransparency = 1
KeyFooter.Parent = KeyFrame

local KeyFooterTitle = Instance.new("TextLabel")
KeyFooterTitle.Size = UDim2.new(1, 0, 0, 16)
KeyFooterTitle.Position = UDim2.new(0, 0, 0, 2)
