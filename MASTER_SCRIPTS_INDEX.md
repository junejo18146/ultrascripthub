...
- **Features Included**:
  ...
  - 2. 🎯 Auto Attack (Near Players) (Auto-detects nearby players within 32 studs, aims & attacks)
  ...
  - 7. 🚀 Teleport To Fruits (Real-time Live Spawned Fruit Scanner & Warp)
  - 8. 👤 Player ESP (Player Health, Display Names & Distance Tags)
  - 9. 💎 Chest ESP (Golden Chest Tags with Live Distance)
  - 10. 🍎 Fruit ESP (Magenta Spawned Fruit Radar & Distance Tags)
  - 11. 🌸 Flower ESP (Race V2 Flower Radar & Tags)
  - 12. 🏃 WalkSpeed Controller (Middle Checkbox Toggle + Right Stepper Pill [ - 50 + ] 16 to 250)
  - 13. 🕊️ Smooth 3D Fly Mode (WASD & Camera Flight)
  - 14. 🦘 Infinite Jump (Dual PC Space & Mobile Touch Jump Support)
  - 15. ⚡ Infinite Energy (Client Energy/Stamina Keep-Alive)
  - 16. 👻 Noclip (Pass through terrain, walls & obstacles)
  - 17. 🛡️ Teleport to Safe Zone (Sky Safe Zone Platform Warp)
  - 18. 📍 12+ Island Teleports (Jungle, Pirate Village, Desert, Marine Fortress, Skylands, Prison, Colosseum, Magma, Underwater, Fountain, Cafe, Mansion)
  - 19. 🛡️ Anti-Drown Floating Safety Platform (Prevents void falling during terrain streaming)
  - 20. 🛡️ 24/7 Anti-AFK Engine (VirtualUser idle disconnect bypass)
  - 21. 📱 Mobile Floating Toggle Button (⚔️ Icon)
- **UI Design**: UI 1 - Official Ultra Script Hub Classic Matte Dark (`280px` width) with Scrollable Content and Centered Branding Footer (`ULTRA SCRIPT HUB` | `Made by Junejo`).
